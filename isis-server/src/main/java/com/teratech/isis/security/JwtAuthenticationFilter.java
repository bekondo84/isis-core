...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
     ...
     */
    public JwtAuthenticationFilter(JwtService jwtService, IsisUserDetailsService userDetailsService, @Qualifier("handlerExceptionResolver") HandlerExceptionResolver resolver) {
